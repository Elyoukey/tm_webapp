var traduction = {
  0: {
    ...
    ABOUT: "À propos du jeu Turing Machine",
    LOAD: "CHARGER",
    ...
    SHARERESULTS: "Partagez vos résultats sur vos réseaux sociaux avec le mot-clic #turingmachinegame"
  },
  1: {
    LANG: "English",
    LANGCODE: "EN",
    ...
    CUSTOM: "Custm game",
    ABOUT: "About the game Turing Machine",
    LOAD: "LOAD",
    ...
    GAMETYPE: "Game type",
    TEXT1: "Get <span class='green'>criteria</span> cards and Verification cards in the box",
    ...
    SHARERESULTS: "Share your results on social media with the hashtag #turingmachinegame\n"
